...
import com.baidu.util.PropertiesReader;
...
public class BasePage {
    ...
    public void switchNextHandle(){
        ...
        for (String handle:allHandles){
            ...
            Assertion.verifyNotEquals(driver.getTitle(), "selenium_百度搜索1", "标题带有'selenium_百度搜索'并且页面无法显示" + "，当前URL:" + driver.getCurrentUrl() + "，当前标题：" + driver.getTitle());
